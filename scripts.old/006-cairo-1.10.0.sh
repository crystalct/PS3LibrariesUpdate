#!/bin/sh -e
# cairo-1.10.0.sh by Naomi Peori (naomi@peori.ca) and CrystalCT (crystal@unict.it - 2020)
...
## Configure the build.
CFLAGS="-I$PSL1GHT/ppu/include -I$PS3DEV/portlibs/ppu/include -DCAIRO_NO_MUTEX -O2 -ffat-lto-objects" \
CPPFLAGS="-I$PSL1GHT/ppu/include -I$PS3DEV/portlibs/ppu/include -DCAIRO_NO_MUTEX -O2 -ffat-lto-objects" \
